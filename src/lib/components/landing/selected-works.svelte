	...
	let items = [
		{
			...
			label: 'Landing Page',
			href: 'https://dewa19.tiketnft.com/'
		},
		{
		...
		},
		{
			...
			label: 'Backend/API',
			href: 'https://pmb.cs.ui.ac.id/'
		}
	];
</script>

<Heading number="I" text="Selected Works" />

<div class="mx-auto container flex justify-center px-4 flex-wrap gap-6">
	{#each items as item}
		<SelectedWorksItem {...item} />
	{/each}
</div>
